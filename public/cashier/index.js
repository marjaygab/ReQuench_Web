...
$('document').ready(function() {
  ...
  login_button.onclick = function() {
    ...
    Swal({
    html:  '<img src="assets/images/logoname.png" style="width:200px;"><br/><br>'+
      ...
      '<button id = "login_button" type="button" style="width:80%"class="btn btn-primary">Log In</button><br><br>'+
      '<button id = "google_login_button" type="button" style="width:80%" class="btn btn-danger">Sign in with Google</button>'+
      '<a id="account_link" href="SignUpCard.html">Create an account</a>',
    ...
    onBeforeOpen: () => {
      ...
      create_account.onclick = function(){
        ...
        window.location.href = 'http://localhost/ReQuench/SignUpCard.html';
      }
